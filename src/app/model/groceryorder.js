...
const groceryorderchema = new mongoose.Schema(
  {
    productDetail: [
      {
        grocery_id: {
...
groceryorderchema.index({ location: "2dsphere" });

module.exports = mongoose.model("GroceryOrder", groceryorderchema);
